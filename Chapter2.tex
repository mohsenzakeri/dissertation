...
% In particular, the evaluation of alignment qualities is considerably complicated due to prevalent 
% multi-mapping in the transcriptome.
% we leave a thorough 
% evaluation of the alignment qualities themselves as future work. 
...
Thus, our procedure for finding \MMSP{s}, that limits match 
...
% su A block diagram of the steps described below are depicted in Figure pport optimal alignments for a read.  
% At this point in our procedure, we follow the approach taken 
...
(which \puffaligner, \bt, and \debga currently do not allow). \Ddebga, is most-related tool to \puffaligner 
...
do not support spliced read alignment. \Ddebga is run in the with options \conf{-o 200 -x 200}, which nominally 
