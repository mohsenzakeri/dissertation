...
scenarios.
\footnote{This is a joint work with Hirak Sarkar and is presented in BCB 2017~\citep{selaln}}

Furthermore, in the second part of this chapter, we build upon the idea of selective 
alignment to introduce Puffaligner~\citep{almodaresi2020puffaligner}, an all purpose 
...
a joint work with Fatemeh Almodaresi and is in the publication 
procedure~\citep{almodaresi2020puffaligner}}
...
Performance of the various methods on a simulated sample is shown in \cref{tab:diff_mutation}. In this case, 
...
In Table \ref{tab:correlations}, we compare the quantification results produced by different methods. Each 
...
% & \num{0.913252923042169} &  \diag{.1em}{0.7cm}{\num{1}}{\num{0}} \\   \hline
% \end{tabular}
...
\debga on the selected genomes. \Cref{fig:size-scaling} shows the time and memory required for constructing 
...
In this paper we introduce \puffaligner, an aligner suitable for the
